...
<h1 style = "text-align : center;">Check out our entire book list</h1>
<section class="one">
...
$query="SELECT * FROM \"livres\" NATURAL JOIN \"Oeuvre\" WHERE \"titre\" LIKE '%". $searchF."%' OR CAST(\"categorie\" AS text) LIKE '%". $searchF."%' OR \"maison_edition\" LIKE '%". $searchF."%' OR \"auteur\" LIKE '%". $searchF."%';";
