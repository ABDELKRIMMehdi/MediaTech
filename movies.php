...
<h1 style = "text-align : center;">Check out our entire movie list</h1>
<section class="one">
...
$query="SELECT * FROM \"films\" NATURAL JOIN \"Oeuvre\" WHERE \"titre\" LIKE '%". $searchF."%' OR CAST(\"categorie\" AS text) LIKE '%". $searchF."%' OR \"realisateur\" LIKE '%". $searchF."%';";
