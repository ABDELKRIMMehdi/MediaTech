...
<h1 style = "text-align : center;">Check out our entire videogame list</h1>
<section class="one">
...
$query="SELECT * FROM \"jeux\" NATURAL JOIN \"Oeuvre\" WHERE \"titre\" LIKE '%". $searchF."%' OR CAST(\"categorie\" AS text) LIKE '%". $searchF."%' OR \"edition\" LIKE '%". $searchF."%' OR \"NomSection\" LIKE '%". $searchF."%';";
